...
func TestSubsystemsApi(t *testing.T) {
	ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case "/redfish/v1/Chassis/1/ThermalSubsystem":
			http.ServeFile(w, r, "testdata/hp/thermal_subsys/hp_thermal_subsys.json")
		case "/redfish/v1/Chassis/1/ThermalSubsystem/ThermalMetrics":
			http.ServeFile(w, r, "testdata/hp/thermal_subsys/hp_thermal_metrics.json")
		case "/redfish/v1/Chassis/1/ThermalSubsystem/Fans":
			http.ServeFile(w, r, "testdata/hp/thermal_subsys/hp_thermal_subsys_fans.json")
		case "/redfish/v1/Chassis/1/ThermalSubsystem/Fans/0":
			http.ServeFile(w, r, "testdata/hp/thermal_subsys/hp_thermal_subsys_fans_0.json")
		case "/redfish/v1/Chassis/1/PowerSubsystem":
			http.ServeFile(w, r, "testdata/hp/power_subsys/hp_power_subsys.json")
		case "/redfish/v1/Chassis/1/PowerSubsystem/PowerSupplies":
			http.ServeFile(w, r, "testdata/hp/power_subsys/hp_power_subsys_psu.json")
		case "/redfish/v1/Chassis/1/PowerSubsystem/PowerSupplies/PowerSupply1":
			http.ServeFile(w, r, "testdata/hp/power_subsys/hp_power_subsys_psu_1.json")
		case "/redfish/v1/Chassis/1/PowerSubsystem/PowerSupplies/PowerSupply1/Metrics":
			http.ServeFile(w, r, "testdata/hp/power_subsys/hp_power_subsys_metrics.json")
		case "/redfish/v1/Systems/1":
			http.ServeFile(w, r, "testdata/hp/hp_systems.json")
		case "/redfish/v1/Chassis/1/":
